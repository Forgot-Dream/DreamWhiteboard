...
const messages = {
  en: {
    ...
    'admin.totalAdmins': 'System administrators',
    'admin.pendingPasswords': 'Awaiting password change',
    'admin.createTitle': 'Create user',
    'admin.createHint': 'Give the user a one-time password of at least 12 characters.',
    'admin.emailLabel': 'Email',
    'admin.nameLabel': 'Display name',
    'admin.passwordLabel': 'One-time password',
    'admin.roleLabel': 'System role',
    'admin.emailPlaceholder': 'name@example.com',
    'admin.namePlaceholder': 'User name',
    'admin.passwordPlaceholder': 'At least 12 characters',
    'admin.add': 'Create user',
    'admin.adding': 'Creating…',
    'admin.userCreated': 'Created {email}.',
    'admin.createFailed': 'Create user failed',
    'admin.directoryTitle': 'User directory',
    'admin.directoryHint': 'Search accounts and manage names, roles, and password setup.',
    'admin.resultCount': '{shown} of {total} users',
    'admin.searchLabel': 'Search users',
    'admin.searchPlaceholder': 'Search name or email',
    'admin.roleFilterLabel': 'Filter users by role',
    'admin.passwordFilterLabel': 'Filter users by password status',
    'admin.filter.allRoles': 'All roles',
    'admin.filter.allStatuses': 'All password statuses',
    'admin.clearFilters': 'Clear filters',
    'admin.loading': 'Loading users…',
    'admin.empty': 'No users yet.',
    'admin.noMatches': 'No users match these filters.',
    'admin.systemRoleFor': 'System role for {email}',
    'admin.displayNameFor': 'Display name for {email}',
    'admin.editName': 'Edit display name',
    'admin.editNameFor': 'Edit display name for {email}',
    'admin.nameUpdated': 'Display name updated.',
    'admin.roleUpdated': 'System role updated.',
    'admin.you': 'You',
    'admin.demoteOwnRoleConfirm': 'Change your own role to standard user? You will immediately lose access to system administration.',
    ...
    'admin.resetPasswordHint': 'This signs out the user and requires a password change at next login.',
    'admin.resetPasswordConfirm': 'Reset the password for {email} and sign out all of their sessions?',
    'admin.resetOwnPasswordConfirm': 'Reset your own password? You will be signed out immediately and must use the new password to sign in again.',
    'admin.confirmReset': 'Confirm reset',
    'admin.resettingPassword': 'Resetting…',
    'admin.passwordReset': 'Password reset. The user must change it at next login.',
    'admin.createdAt': 'Created {time}',
    'admin.status.active': 'Password set',
    'admin.status.mustChange': 'Must change password',
    'admin.role.user': 'Standard user',
    'admin.role.system_admin': 'System administrator',
    ...
    'projects.searchUser': 'Search users by name or email',
    'projects.loadingUsers': 'Loading users…',
    'projects.userResults': 'Matching users',
    'projects.noUserResults': 'No matching users.',
    'projects.userID': 'User ID',
    'projects.memberRole': 'New member role',
    'projects.roleFor': 'Project role for {identity}',
    'projects.add': 'Add',
    ...
    'projects.removeMemberFor': 'Remove {identity}',
    ...
    'editor.back': 'Back',
    'editor.select': 'Select or pan canvas (V)',
  ...
  zh_cn: {
    ...
    'admin.totalAdmins': '系统管理员',
    'admin.pendingPasswords': '待修改密码',
    'admin.createTitle': '新增用户',
    'admin.createHint': '为用户设置至少 12 位的一次性密码。',
    'admin.emailLabel': '邮箱',
    'admin.nameLabel': '显示名称',
    'admin.passwordLabel': '一次性密码',
    'admin.roleLabel': '系统角色',
    'admin.emailPlaceholder': 'name@example.com',
    'admin.namePlaceholder': '用户姓名',
    'admin.passwordPlaceholder': '至少 12 个字符',
    'admin.add': '创建用户',
    'admin.adding': '创建中…',
    'admin.userCreated': '已创建 {email}。',
    'admin.createFailed': '创建用户失败',
    'admin.directoryTitle': '用户目录',
    'admin.directoryHint': '搜索账号并管理名称、角色和密码状态。',
    'admin.resultCount': '显示 {shown} / {total} 位用户',
    'admin.searchLabel': '搜索用户',
    'admin.searchPlaceholder': '搜索姓名或邮箱',
    'admin.roleFilterLabel': '按角色筛选用户',
    'admin.passwordFilterLabel': '按密码状态筛选用户',
    'admin.filter.allRoles': '全部角色',
    'admin.filter.allStatuses': '全部密码状态',
    'admin.clearFilters': '清除筛选',
    'admin.loading': '正在加载用户…',
    'admin.empty': '暂无用户。',
    'admin.noMatches': '没有符合当前筛选条件的用户。',
    'admin.systemRoleFor': '{email} 的系统角色',
    'admin.displayNameFor': '{email} 的显示名称',
    'admin.editName': '编辑显示名称',
    'admin.editNameFor': '编辑 {email} 的显示名称',
    'admin.nameUpdated': '显示名称已更新。',
    'admin.roleUpdated': '系统角色已更新。',
    'admin.you': '当前账号',
    'admin.demoteOwnRoleConfirm': '确定将自己的角色改为普通用户吗？你将立即失去系统管理权限。',
    'admin.oneTimePasswordFor': '{email} 的一次性密码',
    'admin.resetPassword': '重置密码',
    'admin.resetPasswordFor': '重置 {name} 的密码',
    'admin.resetPasswordHint': '该用户的所有会话将退出，下次登录时必须修改密码。',
    'admin.resetPasswordConfirm': '确定重置 {email} 的密码并退出其所有会话吗？',
    'admin.resetOwnPasswordConfirm': '确定重置自己的密码吗？你将立即退出登录，并需要使用新密码重新登录。',
    'admin.confirmReset': '确认重置',
    'admin.resettingPassword': '重置中…',
    'admin.passwordReset': '密码已重置，用户下次登录时必须修改。',
    'admin.createdAt': '创建于 {time}',
    'admin.status.active': '密码已设置',
    'admin.status.mustChange': '必须修改密码',
    ...
    'projects.searchUser': '按姓名或邮箱搜索用户',
    'projects.loadingUsers': '正在加载用户…',
    'projects.userResults': '匹配的用户',
    'projects.noUserResults': '没有匹配的用户。',
    'projects.userID': '用户 ID',
    'projects.memberRole': '新成员权限',
    'projects.roleFor': '{identity} 的项目权限',
    'projects.add': '添加',
    ...
    'projects.removeMemberFor': '移除 {identity}',
